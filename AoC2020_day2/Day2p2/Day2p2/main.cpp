...
//  AoC2020_day2
//
//  Created by Brett Stottlemyer on 12/12/20.
//
...
int main(int argc, const char * argv[]) {
    ...
    for (int index = 0; index < len; index++) {
        ...
        std::string s = input[index];
        std::string token;
        size_t pos = s.find("-");
        token = s.substr(0, pos);
        //std::cout << token << std::endl;
        s.erase(0, pos + 1);
        firstNum = std::stoi(token);
        pos = s.find(" ");
        token = s.substr(0, pos);
        //std::cout << token << std::endl;
        s.erase(0, pos + 1);
        secondNum = std::stoi(token);
        pos = s.find(": ");
        token = s.substr(0, pos);
        //std::cout << token << std::endl;
        s.erase(0, pos + 2);
        character = token.c_str()[0];
        testPassword=s;
        //std::cout << testPassword << std::endl;
//        std::cout << firstNum << std::endl;
//        std::cout << secondNum << std::endl;
//        std::cout << character << std::endl;
        if((testPassword.at(firstNum-1)==character) && (testPassword.at(secondNum-1)!=character)){
            validPasswordCount++;
            //std::cout<<testPassword.at(firstNum)<<std::endl;
        }else if ((testPassword.at(firstNum-1)!=character) && (testPassword.at(secondNum-1)==character)){
            validPasswordCount++;
            //std::cout<<testPassword.at(secondNum)<<std::endl;
        }
...
/*
while ((pos = testPassword.find(character)) != std::string::npos) {
    count++;
    testPassword.erase(0, pos + 1);
}
